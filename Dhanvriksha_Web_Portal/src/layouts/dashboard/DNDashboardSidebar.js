...
export default function DNDashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  const renderContent = (
    ...
    >
      ...
      {/* <NavSection navConfig={DNNavConfig} /> */}
      {role}Anil.
      {role === "Admin" && <NavSection navConfig={DNNavConfigAdmin} />}
      {role === "FO" && <NavSection navConfig={DNNavConfigFO} />}
      {role === "BM" && <NavSection navConfig={DNNavConfigBM} />}
      <Box sx={{ flexGrow: 1 }} />
